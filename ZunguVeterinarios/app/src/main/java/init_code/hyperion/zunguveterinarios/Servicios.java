...
import init_code.hyperion.zunguveterinarios.model.AndroidVersion;

class Servicios extends AppCompatActivity implements LoadJSONTask.Listener, AdapterView.OnItemClickListener {
    ...
    private void loadListView() {
        ...
        ListAdapter adapter = new SimpleAdapter(Servicios.this, mAndroidMapList, R.layout.list_item,
