...
import init_code.hyperion.zunguveterinarios.Clientes;
...
public class ClienteAdapter extends BaseAdapter {
    ...
    ArrayList<String> _listaIDS;
    Context context;

    private static LayoutInflater inflater=null;
    public ClienteAdapter(Clientes mainActivity, ArrayList<String> listaNombreMascota, ArrayList<String> listaNombreCliente, ArrayList<String> listaImgMascotas, ArrayList<String> _listaIDS) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        holder.txtNombreMascota.setText("Última cita: " + _listaNombreMascota.get(position));
        ...
        Picasso.with(holder.imgMascota.getContext()).load(_url).resize(500,500).centerCrop()
